  ...
  const skillCategories = [
    {
      ...
      skills: ['React', 'JavaScript', 'HTML/CSS', 'TailwindCSS', 'Node.js', 'API REST'],
      color: 'from-cyan-500 to-blue-500',
    },
    {
      icon: <Code2 className="w-8 h-8" />,
      title: 'Développement Logiciel',
      skills: ['C#', 'Python', 'Java', 'Architecture logicielle', 'Design patterns', 'Tests unitaires'],
      color: 'from-blue-500 to-indigo-500',
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: 'PC SOFT - Windev',
      skills: ['Windev', 'WindevMobile', 'WLanguage', 'HFSQL', 'Applications desktop', 'RAD'],
      color: 'from-indigo-500 to-purple-500',
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: 'Mobile',
      skills: ['WindevMobile', 'Applications natives', 'UI/UX mobile', 'Responsive design'],
      color: 'from-purple-500 to-pink-500',
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: 'Bases de données',
      skills: ['SQL', 'HFSQL', 'MySQL', 'PostgreSQL', 'MongoDB', 'Optimisation'],
      color: 'from-pink-500 to-rose-500',
    },
    {
      icon: <Cpu className="w-8 h-8" />,
      title: 'Outils & Méthodologies',
      skills: ['Git', 'Agile/Scrum', 'CI/CD', 'Docker', 'VS Code', 'Debugging'],
